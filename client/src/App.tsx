...
import GameFirebase from "@/pages/game-firebase";
import LoginFirebase from "@/pages/login-firebase";
...
function Router() {
  ...
  if (!user) {
    return <LoginFirebase onLoginSuccess={handleLoginSuccess} />;
  }
  ...
  return (
    <Switch>
      <Route path="/" component={() => <GameFirebase user={user} onLogout={handleReturnToPreparation} />} />
